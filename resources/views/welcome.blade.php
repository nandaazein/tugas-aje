    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Selamat datang di website sejarah Kesultanan Banjar
          </h1>
          <h2>Mengungkap Kejayaan dan Kebesaran Warisan Nusantara</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="# {{ route('register') }}" class="btn-get-started scrollto">Get Started</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="{{ asset ('Arsha/assets/img/test.png')}}" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>Narasi Sejarah adalah sebuah website yang didedikasikan untuk menggali dan mengungkap sejarah yang terkait dengan Kesultanan Banjar. Dalam website ini, Anda akan menemukan informasi mendalam dan terperinci mengenai kejayaan dan kebesaran warisan Kesultanan Banjar, yang pernah menjadi salah satu kerajaan terbesar di wilayah Nusantara.
            </p>
            
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              Selain menyediakan informasi sejarah yang mendalam tentang Kesultanan Banjar, website Narasi Sejarah juga menawarkan fitur menarik berupa materi, kuis dan game. Fitur-fitur ini dirancang untuk memberikan pengalaman belajar yang interaktif dan menyenangkan bagi pengunjung.
            </p>
